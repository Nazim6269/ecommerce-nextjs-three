  ...
  return (
    <div className="relative">
      ...
      {isModalOpen && (
        <div
          id="userDropdown1"
          className="absolute top-13 right-2 z-10 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-gray-700"
        >
